...
class ContributorController extends Controller
{
     ...
     *
     * @Route("/", name="workshop_contributor_index")
     * @Method("GET")
     */
    public function indexAction()
    {
        ...
        $contributors = $em->getRepository('AppBundle:Contributor')->findAll();
     ...
     *
     * @Route("/new", name="workshop_contributor_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('workshop_contributor_show', array('id' => $contributor->getId()));
        }
     ...
     *
     * @Route("/{id}", name="workshop_contributor_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{id}/edit", name="workshop_contributor_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Contributor $contributor)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('workshop_contributor_edit', array('id' => $contributor->getId()));
        }
     ...
     *
     * @Route("/{id}", name="workshop_contributor_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, Contributor $contributor)
    {
        ...
        return $this->redirectToRoute('workshop_contributor_index');
    }
    ...
    private function createDeleteForm(Contributor $contributor)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('workshop_contributor_delete', array('id' => $contributor->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
